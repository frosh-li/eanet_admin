...
if (developMode) {
    ...
    require.config({
        packages: [
            {
                name: 'echarts',
                location: '/Public/echarts/src',
                main: 'echarts'
            },
            {
                name: 'zrender',
                //location: 'http://ecomfe.github.io/zrender/src',
                location: '/Public/zrender/src',
                main: 'zrender'
            }
        ]
    });
    ...
    var fileLocation = needMap() ? '/Public/echarts/doc/example/www/js/echarts-map' : '/Public/echarts/doc/example/www/js/echarts';
    require.config({
        paths:{ 
