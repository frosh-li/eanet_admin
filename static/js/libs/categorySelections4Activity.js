 ...
 * v0.1
 * 示例：
 * <script type="text/javascript" src="__PUBLIC__/js/libs/categorySelections4Activity.js"></script>
 * HTML: 
...
//初始化categorySelections4Activity
var initPage = true;
...
function initCategoryLevelOptions()
{
	...
	var innerHTML = '<option selected="selected" value="0">一级类目</option>';
...
function generateCategoryLevel2Option(level1Id)
{
	...
	var innerHTML = '<option selected="selected" value="0">二级类目</option>';
...
{
	$('#category3Id').empty();
	var innerHTML = '<option selected="selected" value="0">三级类目</option>';
