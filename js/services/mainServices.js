...
mainServices.factory('NoitemFeed', ['$resource',
  function($resource){
    return $resource('api/order/noitem/:id', {id:'@id',search:'@search'}, {
      query: {method:'GET', params:{}, isArray:false},
      //get:{method:'GET', params: {ids: "@ids"}, isArray:false},//不用delete方法也不用这个了
      getOne:{method:'GET', params: {id: "@id"}, isArray:false},//为了优化请求地址，实际上应该是{id: "@id"}
      save: {method:'POST', isArray:false},
...
mainServices.factory('ZizhiService', ['$resource',
  function($resource){
    return $resource('api/comp/zizhi/:id', {id:'@id',search:'@search'}, {
